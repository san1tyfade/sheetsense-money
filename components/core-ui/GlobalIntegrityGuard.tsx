          ...
          <div className="max-w-2xl w-full bg-slate-900 border border-slate-800 rounded-[3.5rem] p-10 md:p-16 shadow-2xl relative overflow-hidden group">
            ...
            <div className="relative z-10 space-y-10">
                <div className="flex flex-col items-center text-center space-y-6">
                    <div className="p-6 bg-rose-500/10 text-rose-500 rounded-[2.5rem] border border-rose-500/20 shadow-inner group-hover:scale-105 transition-transform duration-700 animate-pulse">
