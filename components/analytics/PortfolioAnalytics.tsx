...
import { AreaChart, Area, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer, LineChart, Line, BarChart, Bar, Cell, LabelList, ReferenceDot } from 'recharts';
import { Zap, Target, BarChart3, RefreshCw, Activity, TrendingUp, Terminal, Layers, LayoutDashboard, AlertCircle, Calendar } from 'lucide-react';
                        ...
                        {comparisonData.length > 0 ? (
                            <ResponsiveContainer width="100%" height="100%">
                                <LineChart data={comparisonData}>
                                    ...
                                    <YAxis axisLine={false} tickLine={false} tick={{fontSize: 9, fontWeight: 900, fill: theme.axisColor}} tickFormatter={(v) => `${v.toFixed(0)}%`} width={40} />
                    ...
                    <div className="flex-1 w-full min-h-0 relative z-10">
                        <ResponsiveContainer width="100%" height="100%">
                            <AreaChart data={accountAwareData}>
                                <CartesianGrid vertical={false} strokeDasharray="4 4" stroke={theme.gridColor} opacity={0.3} />
                                <XAxis dataKey="date" hide />
                                <YAxis axisLine={false} tickLine={false} tick={{fontSize: 9, fontWeight: 900, fill: theme.axisColor}} width={50} />
                                <Tooltip content={<StandardTooltip isDarkMode={true} />} />
